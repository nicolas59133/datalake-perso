...
from data_platform.assets import bronze, gold, silver

# Tous les assets déclarés dans ces modules.
all_assets = dg.load_assets_from_modules([bronze, silver, gold])

# Un job qui rafraîchit tout le pipeline (bronze -> silver -> gold).
